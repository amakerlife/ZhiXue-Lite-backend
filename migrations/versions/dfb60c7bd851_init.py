...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('zhixue_username', sa.String(length=50), nullable=False),
    sa.Column('exam_id', sa.String(length=50), nullable=False),
    sa.ForeignKeyConstraint(['exam_id'], ['exams.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('zhixue_account_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['zhixue_account_id'], ['zhixue_users.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('username')
    )
